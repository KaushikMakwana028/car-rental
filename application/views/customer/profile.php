...
<div class="page-wrapper">
    ...
    <div class="tabs-container">
        ...
        <button class="tab-button" onclick="switchTab(event, 'addresses')">
            📍 Addresses
        </button>
    </div>
        ...
        <div class="section-grid">
            ...
            <div class="form-section">
                <div class="form-section-header">
                    ...
                    <p>Update your profile photo shown across your account.</p>
                </div>
        ...
        <div class="section-grid">
            <div class="form-section">
                ...
                <div style="margin-bottom: 24px;">
                    <div class="address-card">
                        ...
                        <div class="address-actions">
                            <button class="btn-small btn-edit-small">✏️ Edit</button>
                            <button class="btn-small btn-delete-small">🗑️ Delete</button>
                        </div>
                    </div>
                    ...
                    <div class="address-card">
                        <div class="address-info">
                            <h4>🏢 Office</h4>
                            <p>456 Business Ave<br>Los Angeles, CA 90001<br>United States</p>
                        </div>
                        <div class="address-actions">
                            <button class="btn-small btn-edit-small">✏️ Edit</button>
                            <button class="btn-small btn-delete-small">🗑️ Delete</button>
                ...
                <div style="border-top: 1.5px solid #e2e8f0; padding-top: 24px;">
                    <h4 style="margin-bottom: 16px; color: #1e293b; font-weight: 600;">Add New Address</h4>
                    ...
                    <form>
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Apt 456 (Optional)">
                            </div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (fileInput) {
            ...
            uploadLabel.addEventListener('dragover', function(e) {
                e.preventDefault();
                uploadLabel.style.borderColor = '#0d9488';
                uploadLabel.style.background = '#f0fdf9';
            });
